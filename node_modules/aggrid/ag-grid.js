    ...
    (function (grid) {
        var SelectionRendererFactory = (function () {
            ...
            SelectionRendererFactory.prototype.createSelectionCheckbox = function (node, rowIndex) {
				...
				var eCheckbox=document.createElement('label');
				eCheckbox.className="i-checks i-checks-sm";
				var li=document.createElement('i');
                var eCheckbox1 = document.createElement('input');
                eCheckbox1.type = "checkbox";
                eCheckbox1.name = "name";
                eCheckbox1.className = 'ag-selection-checkbox ng-pristine ng-untouched ng-valid';
                setCheckboxState(eCheckbox1, this.selectionController.isNodeSelected(node));
                var that = this;
                eCheckbox1.onclick = function (event) {
                    event.stopPropagation();
                };
                eCheckbox1.onchange = function () {
                    var newValue = eCheckbox1.checked;
                    if (newValue) {
                ...
                this.angularGrid.addVirtualRowListener(rowIndex, {
                    rowSelected: function (selected) {
                        setCheckboxState(eCheckbox1, selected);
                    },
                    rowRemoved: function () {
                    }
                });
				  eCheckbox.appendChild(eCheckbox1);
				eCheckbox.appendChild(li);
                return eCheckbox;
            };
    ...
    (function (grid) {
        ...
        var RenderedCell = (function () {
            ...
            RenderedCell.prototype.createSelectionCheckbox = function () {
				...
				// <label class="i-checks i-checks-sm"><input type="checkbox" class="ng-pristine ng-untouched ng-valid"><i></i></label>
				this.eCheckbox=document.createElement('label');
				this.eCheckbox.className="i-checks i-checks-sm";
				var li=document.createElement('i');
                this.eCheckbox1 = document.createElement('input');
                this.eCheckbox1.type = "checkbox";
                this.eCheckbox1.name = "name";
				this.eCheckbox1.setAttribute("ng-model","data.IsChecked");
                this.eCheckbox1.className = 'ag-selection-checkbox ng-pristine ng-untouched ng-valid';
                this.eCheckbox1.addEventListener('click', function (event) {
                    event.stopPropagation();
                });
				this.eCheckbox.appendChild(this.eCheckbox1);
				this.eCheckbox.appendChild(li);
                var that = this;
                this.checkboxOnChangeListener = function () {
                    var newValue = that.eCheckbox1.checked;
                    if (newValue) {
                ...
                this.eCheckbox1.onchange = this.checkboxOnChangeListener;
            };
...
(function (ag) {
    ...
    (function (grid) {
        var utils = grid.Utils;
        var template = '<div class="ag-paging-panel" style="text-align:center">' +
            '<span id="pageRowSummaryPanel" class="ag-paging-row-summary-panel displaynone">' +
            '<span id="firstRowOnPage" class="displaynone"> [TO] </span>' +
            '<span id="lastRowOnPage" class="displaynone"> [OF] </span>' +
            '共 ' +
            '<span id="recordCount"></span>' +
			 ' 条' +
            '</span>' +
            '<span class="ag-paging-page-summary-panel displaynone">' +
            ...
            '</span>' +
			'<span><button style="width:30%;display:inline" class="ag-paging-button"  id="btNext">[加载下一页]</button></span>' +
            '</div>';
    ...
    (function (grid) {
        ...
        var ColumnSelectionPanel = (function () {
            ...
            ColumnSelectionPanel.prototype.setupComponents = function () {
                ...
                var localeTextFunc = this.gridOptionsWrapper.getLocaleTextFunc();
                var columnsLocalText = localeTextFunc('columns', '列名称');
                var eNorthPanel = document.createElement('div');
                eNorthPanel.innerHTML = '<div style="text-align: center;padding:5px;">' + columnsLocalText + '</div>';
                this.layout = new grid.BorderLayout({
